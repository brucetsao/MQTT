...
sqlstr1 = """SELECT * FROM dhtdata WHERE 1 order by systime DESC limit 5; """  #查詢 dhtdata 的語法
sqlstr2 = """SELECT * FROM dhtdata WHERE 1 order by systime DESC limit 5; """  #查詢 dhtdata 的語法
